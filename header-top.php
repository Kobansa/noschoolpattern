  ...
  <div class="wrap flex_box">
    <header>
      <div id="header">
        ...
        <!-- <p class="h-copy">学校に行かないときってどうしてる？</p>
        <p class="h-caution">「# 学校に行かないパターン」は学外活動によるわかもののキャリア形成をわかものと共に考えていくプロジェクト。</p> -->

        <?php if(!is_mobile()) { ?>
        <div id="h-pc" class="pc">
          <div id="twiiter-box">
            <a class="twitter-timeline" width="260px" height="400px" href="https://twitter.com/noschoolpattern?ref_src=twsrc%5Etfw">Tweets by n学校に行かないパターン</a>
